          ...
          <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg bg-[#1a0022] border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={searchTerm}
            ...
            <div className="relative">
              <select
                className="px-4 py-2 rounded-lg bg-[#1a0022] border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-[180px] appearance-none pr-8"
                ...
                <tbody className="divide-y divide-white/10">
                  {filteredData.length > 0 ? (
                    filteredData.map((item) => (
                      <tr key={item.eventId} className="hover:bg-white/5 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-white">{item.eventName}</div>
                          <div className="text-xs text-gray-400">ID: {item.eventId}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                            item.status === 5 ? 'bg-green-100 text-green-800' :
                            item.status === 4 ? 'bg-blue-100 text-blue-800' :
