...
export const SearchResultsPage = () => {
  ...
  return (
    <div
      className={cn('min-h-screen pt-32 pb-20 px-4', getThemeClass('bg-gray-50', 'bg-gray-900'))}
    >
      <div className="max-w-7xl mx-auto">
        <div
          className={cn(
            'rounded-2xl shadow-lg p-6 md:p-10 mb-8',
        ...
        >
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                {t('searchResultsFor')}{' '}
                <span className={cn(getThemeClass('text-blue-600', 'text-blue-400'))}>
                  "{query}"
                </span>
              </h1>
            </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === 'grid'
                      ...
                      : getThemeClass('hover:bg-gray-200', 'hover:bg-gray-600')
                  )}
                >
            ...
            >
              {results.map((result) => (
                <Link
                  ...
                  className={cn(
                    'group block overflow-hidden rounded-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-xl shadow-md',
                    viewMode === 'grid'
                      ? getThemeClass(
                          'bg-white',
                          'bg-gray-800 border border-gray-200 dark:border-gray-700'
                        )
                      : getThemeClass(
                          'bg-white grid grid-cols-1 md:grid-cols-3 gap-6 p-4 items-center',
                          'bg-gray-800 border border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-6 p-4 items-center'
                        )
                  )}
                >
                  <div
                    className={cn(
                      ...
                      viewMode === 'grid'
                        ? 'h-56'
                        : 'md:col-span-1 w-full h-48 rounded-xl overflow-hidden'
                    )}
                  >
                    <img
                  ...
                  <div
                    className={cn('flex flex-col', viewMode === 'grid' ? 'p-5' : 'md:col-span-2')}
                  >
                    ...
                    <h3
                      className={cn(
                        'font-bold transition-colors line-clamp-2 flex-grow',
                        getThemeClass(
                    ...
                    <div
                      className={cn(
                        'space-y-2 text-sm mt-auto pt-2 border-t',
                        getThemeClass('border-gray-200', 'border-gray-700/50')
                      )}
                    >
                      <div
                        className={cn(
