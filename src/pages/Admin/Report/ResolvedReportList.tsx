...
import { getResolvedReportsWithFilter } from '@/services/Admin/report.service';
...
export const ResolvedReportList = ({
  ...
  onChangeResolved?: (totalItems: number) => void;
  page: number;
  pageSize: number;
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (onChangeResolved) onChangeResolved(response.data.totalItems);
    } catch (error) {
