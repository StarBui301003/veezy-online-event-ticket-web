      ...
      >
        <div className="sm:wrapper flex sm:h-[100px] h-[57px] items-center justify-between px-7 pr-10">
          ...
          <div className="sm:flex sm:gap-x-8 hidden items-center">
            <Link to="/" className="body-bold-16 text-white whitespace-nowrap border-b border-b-transparent hover:border-neutral-100 transition-colors select-none">
              {t('Home')}
            </Link>
            <Link to="/events" className="body-bold-16 text-white whitespace-nowrap border-b border-b-transparent hover:border-neutral-100 transition-colors select-none">
              {t('Event')}
            </Link>
            <Link to="/news" className="body-bold-16 text-white whitespace-nowrap border-b border-b-transparent hover:border-neutral-100 transition-colors select-none">
              {t('News')}
            </Link>
            <Link to="/terms-of-use" className="body-bold-16 text-white whitespace-nowrap border-b border-b-transparent hover:border-neutral-100 transition-colors select-none">
              {t('Terms of Use')}
            </Link>
          </div>
          {/* desktop search bar */}
